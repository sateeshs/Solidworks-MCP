...
from solidworks_mcp.engineering.electrical import (
    allocate_ports,
...
from solidworks_mcp.engineering.models import (
    HubSpec,
    MotorSpec,
    PortAllocation,
    PowerBudget,
...
class TestCheckWireGauge:
    ...
    def test_voltage_drop_increases_with_length(self) -> None:
        ...
        long = check_wire_gauge(current_a=5.0, length_mm=2000.0, awg=16)
    ...
    def test_drop_percentage_calculation(self) -> None:
        ...
        expected_drop = 2 * 5.0 * 0.01319 * 1.0  # round trip
