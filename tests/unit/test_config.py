...
class TestSolidWorksConfig:
    ...
    def test_invalid_unit_defaults_to_mm(self):
        config = SolidWorksConfig(default_unit="cubits")

        assert config.default_unit == "mm"

    def test_invalid_log_level_defaults_to_info(self):
        config = SolidWorksConfig(log_level="VERBOSE")
    ...
    def test_load_from_json(self, tmp_path):
        ...
        config = SolidWorksConfig.load(str(config_path))
    ...
    def test_load_missing_file_returns_defaults(self, tmp_path):
        config = SolidWorksConfig.load(str(tmp_path / "nonexistent.json"))
    ...
    def test_save_and_load_roundtrip(self, tmp_path):
        ...
        loaded = SolidWorksConfig.load(config_path)
    ...
    def test_get_log_level_int(self):
        config = SolidWorksConfig(log_level="DEBUG")
