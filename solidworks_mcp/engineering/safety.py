...
from .models import InspectionReport, SafetyCheck
...
def _check_size_ftc(
    ...
    if expanded:
        ...
        # Starting configuration: must fit in 18"×18"×18" cube
...
def run_inspection(
    ...
    *,
    ...
    Returns
    -------
    InspectionReport with all check results.
    """
    competition = competition.upper()
    if competition not in ("FTC", "FRC"):
        raise ValueError(f"competition must be 'FTC' or 'FRC', got {competition!r}")
